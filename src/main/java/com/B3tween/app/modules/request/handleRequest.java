...
public class handleRequest {
    ...
    // TODO: Find a way so i can save and load values from the (disk drive or the ram) into the code: use serialization
    // TODO: Move the request and handleRequest.java folder and file into the handler folder instead
    /**
     * 
     */
